...
```typescript
const ShreyPatel = {
  degree      : "M.S. Cybersecurity — George Washington University (GPA: 3.83, May 2026)",
  undergrad   : "B.Tech Computer Science — Nirma University, India (GPA: 3.5)",
  roles       : ["Cybersecurity Researcher", "AI Engineer", "Inventor", "Hackathon Champion"],
  affiliations: [
    "Senior Climate Security Fellow @ Stanford / Naval Postgraduate School",
    "Teaching Assistant — Computer Security & Networks @ GWU",
    "Senator — GWU Student Government Association",
    "Perplexity Student Ambassador | Aspen Cyber Scholar 2025",
    "AWS Re-Inforce & Re-Invent ABW Grant Awardee",
    "World Bank Youth Delegate",
  ],
  ctf_ranking : ["NCL CTF — Rank 120 National", "PicoCTF 2024 — Rank 300 Global", "RevEng.AI CTF"],
  contact     : "s.patel2@gwu.edu  •  Arlington, VA  •  +1 (202) 820-3375",
  philosophy  : "Build things that shouldn't exist yet.",
};
```
...
<!-- HACKATHON WINS - ACCURATE FROM RESUME -->
<div align="center">
...
| 🏅 | **HackWithDC 2026** — Feb 2026 | [**Aegis Desk**](https://aegis-desk-kappa.vercel.app/) — AGI-inspired autonomous agent: cross-domain reasoning, Trust Ledger, real-time web intelligence via LinkUp API | **Top 5 Finalist** *(Privacy-First AI / Autonomous Reasoning Track)* |
| 🏆 | **Google DevFest DC 2025** — Oct 2025 | [**EconoSense Agent**](https://econosense-agent.lovable.app/) — Agentic AI (Google ADK) predicting citizen reactions & economic impact of government policies; presented at DC Tech & Startup Week 2025 | **Most Innovative Project Award** *(Finance & Public Interest Track)* |
| 🥇 | **George Hacks Innovation Hackathon 2025** — Mar 2025 | [**RootSync**](https://rootsync.netlify.app/) — AI chatbot + IoT soil sensors → real-time soil diagnostics + ML-driven crop rotation advice (36-hour build) | **1st Place** *(Health & Environment Track)* |
| 🥇 | **AES Cryptanalysis Hackathon** — Nirma University | Cryptanalysis challenge | **1st Place** |
...
<div align="center"><h2>🐍 CONTRIBUTION MAP</h2>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Shreyp087/Shreyp087/output/github-contribution-grid-snake-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Shreyp087/Shreyp087/output/github-contribution-grid-snake.svg">
  <img alt="github contribution grid snake animation" src="https://raw.githubusercontent.com/Shreyp087/Shreyp087/output/github-contribution-grid-snake.svg">
</picture>
</div>
...
[![DevPost](https://img.shields.io/badge/DevPost-Shreyp087-003E54?style=flat-square&logo=devpost)](https://devpost.com/Shreyp087)
